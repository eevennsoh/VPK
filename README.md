...
│   └── use-streaming-chat.ts      # Reusable SSE streaming for AI
...
- Uses `@atlaskit/app-provider` for ADS token synchronization
...
Use the `/vpk-design` skill for comprehensive Atlassian Design System reference.
