...
A Next.js app with Atlassian AI Gateway integration, deployable to Micros.
...
| Script                      | Description                            |
| --------------------------- | -------------------------------------- |
| `pnpm run dev`              | Both frontend and backend (concurrent) |
...
| `./.claude/skills/vpk-setup/scripts/start-dev.sh`  | Start both services (recommended)      |
| `./.claude/skills/vpk-setup/scripts/stop-dev.sh`   | Stop dev services                      |
| `./.claude/skills/vpk-deploy/scripts/deploy.sh`    | Deploy to Micros                       |
...
```bash
./.claude/skills/vpk-deploy/scripts/deploy.sh <service-name> <version>
# Example: ./.claude/skills/vpk-deploy/scripts/deploy.sh my-prototype 1.0.1
```
...
```bash
./.claude/skills/vpk-setup/scripts/stop-dev.sh
# or manually:
