...
assistant: "I'll use the vpk-design-ads agent to create an accessible, ADS-compliant search modal."
</example>
...
assistant: "I'll use the vpk-design-ads agent to implement the card layout."
</example>
...
assistant: "I'll use the vpk-design-ads agent to implement the Figma design with ADS."
</example>
...
assistant: "I'll use the vpk-design-ads agent to review the ADS compliance."
</example>
