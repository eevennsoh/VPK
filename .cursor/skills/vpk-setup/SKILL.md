...
|------|---------|-------------|
| **Create your own repo** | `/vpk-repo --create my-project` | Creates a new GitHub repo with VPK sync configured |
...
2. `/vpk-repo --create my-project` — Create your own repo (optional but recommended)
